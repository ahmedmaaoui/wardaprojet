...
if(isset($_POST['update_product'])){
   ...
   mysqli_query($conn, "UPDATE `flowers` SET name = '$name', detail = '$detail', price = '$price',   price_redux='$price_reduction'  WHERE id = '$update_p_id'") or die('query failed');
...
<form action="" method="post" enctype="multipart/form-data">
   ...
   <input type="number" min="0" class="box" value="<?php echo $fetch_products['price_redux']; ?>" required placeholder="update product reduction" name="price_redux">
