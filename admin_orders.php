...
if(isset($_POST['update_orders'])){
   $order_id = $_POST['id'];
   $update_payment = $_POST['update'];
   mysqli_query($conn, "UPDATE `orders` SET payement = '$update_payment' WHERE id = '$order_id'") or die('query failed');
